      ...
      <div className="w-full max-w-md">
        <div className="bg-jet-900 border border-white/20 p-8">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-primary-400 mx-auto mb-4 flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-black border border-white/20 text-white placeholder-gray-500 focus:outline-none focus:border-primary-400"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-primary-400 hover:bg-primary-500 disabled:bg-primary-600 text-black py-4 px-6 font-bold uppercase tracking-wider disabled:cursor-not-allowed transition-colors"
            >
